const data = {
  lista: [
    ...
    },
    {
      ...
      pais: "Estados Unidos",
      resenia:
        "Margaret Hamilton (Paoli, Estados Unidos, 17 de agosto de 1963)) fue directora de ingeniería de software para el proyecto que escribió el código de la Guía de Apollo Computer (AGC). Desarrollado en el Laboratorio de Instrumentación del MIT para la misión Apolo 11, los programadores, literalmente, tuvieron que empezar de cero.",
    },
    {
      id: 4,
    ...
    },
    {
      ...
      pais: "Estados Unidos",
      resenia:
        "Brendan Eich (Pittsburgh, Estados Unidos, 4 de julio de 1961) es un tecnólogo estadounidense y creador del lenguaje de programación JavaScript. Cofundó el proyecto Mozilla, la Fundación Mozilla y la Corporación Mozilla, y se desempeñó como director técnico de la Corporación Mozilla y brevemente, como su director ejecutivo. Es el CEO de Brave Software.",
    },
    {
      id: 10,
      nombre: " Ryan Dahl",
...
module.exports=data;  //uso el nombre data, porque es el que voy a usar despues para importarlo en heroeController